...
def computeAndComparePredicted(theta_file, selected_id=None, out_dir='.', start_count=0, end_count=10000):
    ...
    for (old_id, new_id) in id_pairs:
        ...
        if selected_id is not None and selected_id != old_id and selected_id != new_id:
...
if __name__ == '__main__':
    ...
    computeAndComparePredicted(theta_file, selected_id='Oligo69920', out_dir='/results/predicted_vs_measured_example')
