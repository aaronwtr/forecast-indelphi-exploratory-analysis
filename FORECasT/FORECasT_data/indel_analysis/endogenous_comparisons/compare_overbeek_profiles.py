...
def compareOverbeekProfiles(selected_overbeek_id=None, pred_results_dir = '../indel_prediction/model_testing'):
    ...
    for idx in range(1,97):
        ...
        if selected_overbeek_id is not None:
            ...
            plotProfiles([p1_old_reps[0],p1_old_reps[1],p1_new_reps[0],p1_new_reps[0], o1], [rr_old_reps[0],rr_old_reps[1],rr_new_reps[0],rr_new_reps[1],rr_new_reps[1]], [pam_loc1,pam_loc1,pam_loc1,pam_loc1,pam_loc2],[x=='REVERSE' for x in [pam_dir1, pam_dir1, pam_dir1,pam_dir1,pam_dir2]],labels, title=title)
